...
@Table(name = "tb_pick_give_car_order")
public class TbPickGiveCarOrder {
    /**
     * 主键ID
     */
    @Id
     ...
     */
    public void setSalerTime(Date salerTime) {
